...
function [T2C_err,networkData,stationData,ncFileNoPath,ncFilesize] = tot2netCDF_v22(mat_tot, networkData, networkFields, stationData, stationFields,timestamp,institutions)

disp(['[' datestr(now) '] - - ' 'tot2netCDF_v22.m started.']);
...
if(T2C_err==0)
    disp(['[' datestr(now) '] - - ' 'tot2netCDF_v22.m successfully executed.']);
end
