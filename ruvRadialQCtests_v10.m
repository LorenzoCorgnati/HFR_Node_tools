...
function [overall, overWater, varThr, tempDer, velThr, medFilt, avgRadBear, radVelMedianFiltered, radCount] = ruvRadialQCtests_v10(bear, lond, latd, owtr, etmp, head, radVel, Radial_QC_params)

display(['[' datestr(now) '] - - ' 'ruvRadialQCtests_v10.m started.']);
