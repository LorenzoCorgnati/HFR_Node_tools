...
function [T2C_err,networkData,ncFileNoPath,ncFilesize] = tuv2netCDF_v31(totFilename,timestamp,networkData,networkFields)

disp(['[' datestr(now) '] - - ' 'tuv2netCDF_v31.m started.']);
...
%% Insert Fill Values instead of NaN
