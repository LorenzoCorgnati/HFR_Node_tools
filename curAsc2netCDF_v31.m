...
function [cA2C_err,networkData,ncFileNoPath,ncFilesize] = curAsc2netCDF_v31(totFilename,timestamp,networkData,networkFields)

disp(['[' datestr(now) '] - - ' 'curAsc2netCDF_v31.m started.']);
